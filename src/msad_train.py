...
from utils.dataset import XDDataset,MSADDataset
...
if __name__ == '__main__':
    ...
    print("Training has started on device: ",device)
    setup_seed(args.seed)

    label_map = dict({'Normal': 'normal', 'Anomaly': 'anomaly'})

    train_dataset = MSADDataset(args.visual_length, args.train_list, False, label_map)
